    ...
    window.AudioContext=window.AudioContext||window.webkitAudioContext||window.mozAudioContext;
        ...
        var msc=['高姗 - 遇见你的时候所有星星都落到我头上','高姗 - 遇见你的时候所有星星都落到我头上','高姗 - 遇见你的时候所有星星都落到我头上'];
		var mscsrc=['msc/高姗 - 遇见你的时候所有星星都落到我头上.mp3','msc/高姗 - 遇见你的时候所有星星都落到我头上.mp3','msc/高姗 - 遇见你的时候所有星星都落到我头上.mp3'];
		var mscid=0;
	function playa(id){
		mscid=id;
	...
	function cgcolor(){
	  ...
	  function run(){
	  	if(tf==''||tf=='t'){
	  		...
	  		tf='t';
	  		setTimeout(function(){$('#canvas').css('display','none')},1000);
	  	}
